...
pub fn part1(input: &str) -> u32 {
    ...
    part1_buffer_backwards(&input[..input.len() - 1])
}

pub fn part2(input: &str) -> u32 {
    let input = input.as_bytes();
    part2_buffer_backwards(&input[..input.len() - 1])
}

fn find_trailhead_rating_buffer_backwards(
    input: &[u8],
    start: usize,
    width: usize,
    height: usize,
    ...
    let mut score = 0u32;
    queue.push((start, start % width, start / width, b'9'));
...
fn find_trailhead_score_buffer_backwards(
    input: &[u8],
    start: usize,
    width: usize,
    height: usize,
...
#[aoc(day10, part1, buffer_backwards)]
pub fn part1_buffer_backwards(input: &[u8]) -> u32 {
    let width = input.iter().position(|&c| c == b'\n').unwrap() + 1;
    let height = input.len() / width;
    let mut buffer = Vec::new();
    memchr::memrchr_iter(b'9', input)
        .map(|start| {
            find_trailhead_score_buffer_backwards(input, start, width, height, &mut buffer)
        })
        .sum()
}
...
#[aoc(day10, part2, buffer_backwards)]
pub fn part2_buffer_backwards(input: &[u8]) -> u32 {
    let width = input.iter().position(|&c| c == b'\n').unwrap() + 1;
    let height = input.len() / width;
    let mut buffer = Vec::new();
    memchr::memrchr_iter(b'9', input)
        .map(|start| {
            find_trailhead_rating_buffer_backwards(input, start, width, height, &mut buffer)
        })
        .sum()
}
